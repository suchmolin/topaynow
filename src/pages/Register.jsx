  ...
  async function handleGoogleSignIn() {
    ...
    try {
      ...
      if (err.code === 'auth/popup-closed-by-user' || err.code === 'auth/cancelled-popup-request') {
        ...
        setError('Ese correo ya está registrado con email/contraseña. Inicia sesión ahí o usa "¿Ya tienes cuenta?"')
      } else {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center px-6 py-8">
      <div className="w-full max-w-sm mx-auto">
        ...
        <p className="text-gray-500 text-sm mb-6">Regístrate para usar la aplicación</p>
